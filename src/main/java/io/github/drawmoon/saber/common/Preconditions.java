...
public final class Preconditions {
   ...
   */
  public static <T> void checkNotNull(T t1) {
   ...
   */
  public static <T> void checkNotNull(T t1, String errorMessage) {
    if (t1 == null) throw new NullPointerException(errorMessage);
  }
