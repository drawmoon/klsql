...
public class SaberOptions {
  ...
  public SaberOptions() {
    this.dataSourceLifetime = DEFAULT_DATA_SOURCE_LIFETIME;
    this.dataSourceLimit = DEFAULT_DATA_SOURCE_LIMIT;
    this.dataSourceLimitPolicies = DEFAULT_DATA_SOURCE_LIMIT_POLICIES;
    this.maximumPoolSizeLimit = DEFAULT_MAXIMUM_POOL_SIZE_LIMIT;
