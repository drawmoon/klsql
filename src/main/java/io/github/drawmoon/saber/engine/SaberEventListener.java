...
public interface SaberEventListener {
  ...
  // ***********************************************************************
  /**
   * This callback method is executed before any of the {@link DataSourceStore#get} methods are
   * invoked.
   *
   ...
   */
  void onBeforeGetDataSource(DataSourceStore store, SaberOptions options, RequestContext context);

  /**
   * This callback method is executed after any of the {@link DataSourceStore#get} methods are
   * invoked.
   *
   * @param store the store
   * @param options the options
