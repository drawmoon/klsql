...
public class JoinExpression implements Table {
  ...
  public List<Field> getFields() {
    ...
    fields.addAll(this.lhs.getFields());
    fields.addAll(this.rhs.getFields());
  ...
  public Iterator<Expression> iterator() {
    return ExpressionIterator.sameAsExpression(
        this.lhs, this.rhs, this.type, this.hint, this.condition);
  }
}
